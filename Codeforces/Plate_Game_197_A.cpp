// problem link : https://codeforces.com/contest/197/problem/A
// game based approach where one candidate aims to win
// have to try to look for a solutions such that one candidate has an advantage over the other
