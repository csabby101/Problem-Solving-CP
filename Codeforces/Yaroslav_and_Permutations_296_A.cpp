...
void sarthak()
{
    ...
    // Example
    // A_A_A : i.e. 5 elements and 3 are same. 
    // Greedy approach as illustrated(?) by the A's representing the similar items and 
    // the gaps that must be available to fill dissimilar items.
